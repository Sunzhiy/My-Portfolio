    ...
    <>
      <div className="h-2/5">
        ...
        <div className="grid grid-cols-2 h-1/2">
          {languages.map((language) => (
            <div className="flex flex-col bg-blue-200 rounded-3xl items-center  w-1/3  justify-self-center justify-center min-h-24 min-w-24  sm:text-2xl dm:text-3xl hover:scale-110 shadow-2xl hover:shadow-blue-500">
      ...
      <div className="h-2/5">
        ...
        <div className="grid grid-cols-2  border-amber-500  h-1/2">
          {data.map((Data) => (
            <div className="flex flex-col bg-amber-200 rounded-3xl items-center  w-1/3  justify-self-center justify-center min-h-24 min-w-24  sm:text-2xl dm:text-3xl hover:scale-110 shadow-2xl hover:shadow-amber-500">
              <div>{Data.icon}</div>
              <p>{Data.name}</p>
            </div>
          ))}
      ...
      <div className="h-2/5">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 h-1/2 gap-3">
          {tools.map((tool) => (
            <div className="flex flex-col bg-rose-200 rounded-3xl items-center  w-1/3 h-full justify-self-center justify-center min-h-24 min-w-24  sm:text-2xl dm:text-3xl hover:scale-110 shadow-2xl hover:shadow-rose-500">
              <div>{tool.icon}</div>
              <p>{tool.name}</p>
            </div>
          ))}
